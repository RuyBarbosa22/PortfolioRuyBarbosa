...
export const HeroLeft: React.FC<HeroLeftProps> = ({
  ...
  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.4] pb-2 overflow-visible text-center lg:text-left sm:whitespace-nowrap">
      ...
      <p className="text-sm sm:text-base md:text-lg text-gray-400 font-['Roboto_Mono',monospace] font-normal mb-10 md:mb-12 xl:mb-14  md:max-w-280px] xl:max-w-xl leading-relaxed lg:mx-0 text-justify lg:px-0">
        {language === "pt" && (
          <>
